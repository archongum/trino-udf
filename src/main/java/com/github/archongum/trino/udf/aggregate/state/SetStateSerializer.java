 ...
 * @since
 */
public class SetStateSerializer implements AccumulatorStateSerializer<SetState>
{
    ...
    @Override
    public void serialize(SetState state, BlockBuilder out) {
        try {
    ...
    @Override
    public void deserialize(Block block, int index, SetState state) {
        try {
